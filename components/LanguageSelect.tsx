...
const languages = [
  { value: 'Natural Language, explain completely, in verbose detail each of the operations, Defaults, equations, and calculations contained within the input as if you were to reverse engineer the code, please provide your response in English', 		label: '1 - Natural Language -' },
